...
abstract class BasesfGuardUserFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'notification_mode' => new sfWidgetFormFilterInput(array('with_empty' => false)),
      'cv_url'            => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'notification_mode' => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
      'cv_url'            => new sfValidatorPass(array('required' => false)),
