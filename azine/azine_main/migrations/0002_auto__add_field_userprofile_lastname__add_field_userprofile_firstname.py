...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('azine_main_userprofile', 'lastname', self.gf('django.db.models.fields.CharField')(default='lastname', max_length=255), keep_default=False)

        # Adding field 'UserProfile.firstname'
        db.add_column('azine_main_userprofile', 'firstname', self.gf('django.db.models.fields.CharField')(max_length=255, null=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'UserProfile.lastname'
        db.delete_column('azine_main_userprofile', 'lastname')

        # Deleting field 'UserProfile.firstname'
        db.delete_column('azine_main_userprofile', 'firstname')
